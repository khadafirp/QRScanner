package com.example.qrscanner.qrscan;
...
import com.example.qrscanner.api.Api;
    ...
    public void scanQr(String nis){
        ...
        Api.create().filterData(nis).subscribe(new Observer<Map<String, Object>>() {
            ...
            public void onNext(Map<String, Object> map) {
                ...
                Log.d("pinter", String.valueOf(map.get("statusCode")));
                dialog.dismiss();
                try {
...
//                      alertDialog.getWindow().getAttributes().windowAnimations = R.style.DialogStyle;
                        ...
                        Map<String, Objects> mapDua = ((Map<String, Objects>) map.get("data"));
