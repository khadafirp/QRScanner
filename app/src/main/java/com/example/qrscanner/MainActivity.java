...
import com.example.qrscanner.kelompok.KelompokActivity;
import com.example.qrscanner.qrscan.ScanActivity;
import com.example.qrscanner.tambahSiswa.TambahSiswaActivity;

import pub.devrel.easypermissions.EasyPermissions;

public class MainActivity extends AppCompatActivity {

    CardView cvBtnScan, cvBtnKelompok;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cvBtnKelompok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, KelompokActivity.class);
